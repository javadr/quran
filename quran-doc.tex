...
\section{Frequently Asked Questions}
    ...
    Another choice is \xpackage{arabluatex} that just works with \LuaLaTeX{} while former 
    choices work with \XeLaTeX. \xpackage{arabluatex}  uses Amiri font by default. 
    The following demonstrates  examples for all three approaches:
